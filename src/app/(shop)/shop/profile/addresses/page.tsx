  ...
  return (
    <section className="container" style={{ padding: 'var(--space-6) 0 var(--space-10)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--space-6)', gap: 'var(--space-3)', flexWrap: 'wrap' }}>
        <div>
          <h1 style={{ fontSize: 'var(--text-xl)', fontWeight: 'var(--font-bold)', marginBottom: 'var(--space-2)' }}>Manage Addresses</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: 'var(--text-sm)' }}>Add, remove, or set your default delivery address.</p>
        </div>
        <Link href="/shop/profile" className="btn btn-ghost">← Back to Profile</Link>
      </div>
