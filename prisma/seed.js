// Temporary CommonJS seed runner for environments without ts-node
const { PrismaClient, AdminPermissionType, AccountStatus, UserRole } = require('@prisma/client')
const bcrypt = require('bcryptjs')

const prisma = new PrismaClient({})

async function main() {
  console.log('🌱 Starting Asshrabha database seed (JS)...\n')
